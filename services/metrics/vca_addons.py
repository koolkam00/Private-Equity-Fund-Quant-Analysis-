...
VCA_COLUMNS = [
    ...
    {"key": "acquired_tev", "label": "Acquired TEV", "numeric": True},
    ...
    {"key": "add_on_tev_pct_of_exit", "label": "Add-On TEV % of Exit", "numeric": True},
...
VCA_HEADER_GROUPS = [
    ...
    {"label": "Value Creation ($)", "span": 5},
    {"label": "Company Op. Metrics At Entry", "span": 9},
    {"label": "Add-Ons", "span": 6},
    {"label": "Company Op. Metrics At Exit / Current", "span": 9},
    {"label": "Difference Exit/Current vs Entry", "span": 9},
]
...
FORMULA_LEGEND = {
    ...
    "add_on_tev_pct_of_exit": "Acq TEV / Exit TEV",
    ...
    return {
        "meta": {
            ...
            "footnotes": [
                ...
                "Acquired TEV, Acquired Revenue, and Acquired EBITDA come directly from the uploaded add-on columns.",
